...
answer = input("\nGiraffes have the highest blood pressure of all land animals. True or false? ")
...
answer = input("\nHipppotamous calves are sometimes born underwater. True or false? ")
if answer.lower() == "true":
...
answer = input("\nOrangutans hold leaves over their heads when it rains. True or false? ")
if answer.lower() == "true":
